...
In this section, we implement several models to predict `MSRP` and to learn more about variables influencing car prices. I will be using Root Mean Square Error (RMSE) as my metric for all of the models. RMSE is used to quantify how far predictions are from the true values. As mentioned above in the recipe building, I will be using Stepwise Linear Regression, Lasso Regression, Random Forest, and PCA Regression. 
