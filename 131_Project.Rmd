...
ggplot(NA_car_data, aes(MSRP)) +
  geom_boxplot(fill = "plum") + coord_flip() + labs(x = "MSRP (in thousands)")
ggplot(NA_car_data, aes(highway.MPG)) +
  geom_boxplot(fill = "powderblue") + coord_flip() + labs(x = "Highway MPG")
ggplot(NA_car_data, aes(Engine.HP)) +
  geom_boxplot(fill = "lavender") + coord_flip() + labs(x = "Engine Horse Power")
...
ggplot(outliers_removed_car_NA, aes(MSRP)) +
  geom_boxplot(fill = "plum3") + coord_flip() + labs(x = "MSRP (in thousands)")
