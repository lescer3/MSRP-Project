...
# Boxplot for MSRP
boxplot(NA_car_data$MSRP, horizontal = TRUE, col = "plum",
        xlab = "MSRP (in thousands)", main = "MSRP")

# Boxplot for Highway MPG
boxplot(NA_car_data$highway.MPG, horizontal = TRUE, col = "powderblue",
        xlab = "Highway MPG", main = "Highway MPG")

# Boxplot for Engine HP
boxplot(NA_car_data$Engine.HP, horizontal = TRUE, col = "lavender",
        xlab = "Engine Horse Power", main = "Engine HP")
